...
def  nickwriterpointer   = $c7c9
def  nickwriterdest      = $c800
def  AskName_Hijack      = AskName + $39     ; jump 0x39 (RB) / 0x38 (Y) bytes into AskName
def  bankswitch1         = $1375
def  counterlow          = $9290
def  counterhigh         = $9610
def  pokeid              = $da               ; glitch pokemon with 2 graphics tiles in its name
