...
def spriteinrom     = $4b71
def romtrucktiles   = $69f0
def truckids        = $6c40
def mewsprite       = $8180
...
def palette         = $04
def vramsprite      = $03
def spritestate     = wSprite02StateData1
def spritey         = wSprite02StateData2MapY
def spriteimage     = wSprite02StateData2ImageBaseOffset



SECTION "Main", ROM0
LOAD "Installer", WRAMX[nickaddress]
; ----------- Installer payload ------------ 
installer:
...
LOAD "Event_payload", WRAM0[installaddress]

;;;;;;;;;;;;;; Executed by script selector ;;;;;;;;;;;;;;;;;;
copy:
ld   bc, (endscript - start)
ld   de, nickaddress
ld   hl, endcopy
call CopyData
...
ld   hl, .textPointer-2            ; in yellow text pointers dont start from 1
