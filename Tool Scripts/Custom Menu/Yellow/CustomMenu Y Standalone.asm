...
Compatible with EN Yellow ONLY
...
start:
LOAD "CustomMenu", WRAMX[nicknameaddress]
...
tablelist:
db   listitems
; you need to leave as many free bytes as listitems value before you input anything else.
; the script will use them to create the item id for every menu item.
