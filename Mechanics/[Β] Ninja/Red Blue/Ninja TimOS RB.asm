...
; Copy payloads
ld   hl, installend
ld   c, finish-payload + endjack-start
jp   CopyMapConnectionHeaderloop

installend:
ENDL

LOAD "SuperSpeed", WRAM0[timosinstalladr]
...
and  a
jr   nz, speedon         ; don't run if auto moving/spinning
...
speedon:
bit  0, c                ; check if button A is pressed
jp   z, returnaddress
